...
@Component
@Slf4j
public class ACBConsumer extends MessageConsumer {
    private static final String FILE_NAME = "SHb.xlsx";

    private static final String FILE_PATH = "C://Users//Admin//Documents//" + FILE_NAME;
    private final JmsTemplate queueJmsTemplate;

    public ACBConsumer(ObjectMapper objectMapper, JmsTemplate topicJmsTemplate, @Qualifier("queueJmsTemplate") JmsTemplate queueJmsTemplate) {
