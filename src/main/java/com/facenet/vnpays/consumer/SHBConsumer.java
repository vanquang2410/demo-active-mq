...
@Component
@Slf4j
public class SHBConsumer extends MessageConsumer {
    ...
    public SHBConsumer(ObjectMapper objectMapper, JmsTemplate topicJmsTemplate, @Qualifier("queueJmsTemplate") JmsTemplate queueJmsTemplate) {
